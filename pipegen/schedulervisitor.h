...
public:
    ...
    // The final nested schedule: an array of nodes at the root (like PrintLoopNest lines)
...
private:
    ...
    static std::string to_string(Halide::ForType t) {
        using Halide::ForType;
        switch (t) {
        ...
        case ForType::GPUBlock: return "GPUBlock";
        case ForType::GPUThread: return "GPUThread";
        case ForType::GPULane: return "GPULane";
    ...
    static std::string to_string(Halide::DeviceAPI api) {
        ...
        switch (api) {
        case DeviceAPI::None: return "None";
        case DeviceAPI::Host: return "Host";
        case DeviceAPI::OpenCL: return "OpenCL";
        case DeviceAPI::GLSL: return "GLSL";
        case DeviceAPI::Metal: return "Metal";
        case DeviceAPI::CUDA: return "CUDA";
        case DeviceAPI::Hexagon: return "Hexagon";
        case DeviceAPI::D3D12Compute: return "D3D12Compute";
        case DeviceAPI::Vulkan: return "Vulkan";
        case DeviceAPI::WebGPU: return "WebGPU";
        default: return "Unknown";
        }
    }
