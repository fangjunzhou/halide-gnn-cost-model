#ifndef HALIDE__pipelines___example___pipeline_h
#define HALIDE__pipelines___example___pipeline_h
#include <stdint.h>
...
int h(struct halide_buffer_t *_h_buffer);

HALIDE_FUNCTION_ATTRS
int h_argv(void **args);

HALIDE_FUNCTION_ATTRS
const struct halide_filter_metadata_t *h_metadata();
